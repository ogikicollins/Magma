# MAGMA — Live Account File
**Prospect:** MagmaLabs (magmalabs.io)
**Owner:** Collins Ogiki | SELLL.io
**Opened:** June 26, 2026
...
| Name | Role | Status |
|---|---|---|
| Carlos Rocha | CEO / Decision Maker | Not yet in thread |
| Victor | Day-to-day contact | On the disco call |
| Mariana | Day-to-day contact | On the disco call |
| Obie Fernandez | Founder | Background — split attention risk |

---

## WHAT WE KNOW

- Inbound arriving but not converting
- No GTM motion — fragmented campaigns
- Instagram as primary B2B channel (wrong room)
- No SDR, no cold calling, no sequences
- On LinkedIn — not reading or acting on signals
- Lost Genoa (9-year client) — referral model is a liability
- Two ICPs: Rails staff aug + AI services (need separate sequences)
- Demo/pitch is strong — pipeline is the gap
...
| Date | Item | To |
|---|---|---|
| June 2026 | Post-disco deck (13 slides, rebuilt with call intel) | Victor + Mariana |
| June 2026 | Hyper-personalised follow-up email | Victor + Mariana |
...
- [Full Engagement Extract](MagmaLabs-Engagement-Extract.md)
- [GTM Audit](magmalabs-gtm-audit.md)
- [Follow-Up Email Sent](MagmaLabs-FollowUp-Email.txt)
- [Disco Deck](MagmaLabs-Disco-Deck.pptx)
